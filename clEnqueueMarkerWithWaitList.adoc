...
Event objects are unique and can be used to identify this marker command later on.
...
<<clWaitForEvents.adoc#, `clWaitForEvents`>>, <<clEnqueueBarrierWithWaitList.adoc#, `clEnqueueBarrierWithWaitList`>>

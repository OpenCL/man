...
* `CL_INVALID_VALUE` if the region being written specified by (`buffer_origin`, `region`, `buffer_row_pitch`, `buffer_slice_pitch`) is out of bounds.
...
<<clEnqueueCopyBuffer.adoc#, `clEnqueueCopyBuffer`>>, <<clEnqueueCopyBufferRect.adoc#, `clEnqueueCopyBufferRect`>>, <<clEnqueueWriteBuffer.adoc#, `clEnqueueWriteBuffer`>>, <<clEnqueueReadBufferRect.adoc#, `clEnqueueReadBufferRect`>>, <<clEnqueueReadBuffer.adoc#, `clEnqueueReadBuffer`>>
